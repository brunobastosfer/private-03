    ...
    <div className="w-full max-w-[1400px]">
      ...
      <div className="bg-white rounded-lg shadow-sm">
        ...
        <div className="p-6 pb-4">
          <h2 className="text-xl font-semibold text-[#3FA110]">Lista de Conquistas</h2>
        </div>
        ...
        <div className="max-h-[600px] overflow-y-auto lista-scroll">
          {isLoading ? (
            ...
            <div className="text-center py-8 text-gray-500">Nenhuma conquista encontrada</div>
          ) : (
                ...
                {conquistas.map((conquista) => (
                  <div key={conquista.id} className="border-b border-[#3FA110] pb-4 last:border-b-0">
                    <div className="flex justify-between items-center gap-4">
                      {/* Lado esquerdo: Nome e Descrição da Conquista */}
                      <div className="flex-1">
                        <h3 className="text-sm font-semibold text-black">{conquista.title}</h3>
                        <p className="text-xs text-gray-600 mt-1">{conquista.description}</p>
                      </div>
